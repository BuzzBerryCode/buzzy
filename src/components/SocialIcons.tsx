...
export const SocialIcons = (): JSX.Element => {
  return (
    <div className="grid grid-cols-3 gap-4 max-w-xs mx-auto">
      ...
      {/* Instagram */}
      <div className="w-16 h-16 bg-gradient-to-br from-purple-600 via-pink-600 to-orange-400 rounded-2xl flex items-center justify-center shadow-lg">
        <svg width="24" height="24" viewBox="0 0 24 24" fill="white">
      ...
      {/* Twitter */}
      <div className="w-16 h-16 bg-blue-400 rounded-2xl flex items-center justify-center shadow-lg">
        <svg width="24" height="24" viewBox="0 0 24 24" fill="white">
